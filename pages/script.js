...
if (selectedTime) {
    timeHeader.textContent = 'Time: ' + selectedTime;
} else {
    timeHeader.textContent = 'Time: Not Selected';
}

// Function to randomly mark seats as sold
...
// Call the randomizeSeats function to mark seats as sold
randomizeSeats();